...
const faqs = [
  {
    q: "Что такое токены?",
    a: "Токены — внутренняя валюта CV Builder. При регистрации вы получаете 50 бесплатных токенов. Каждая операция списывает определённое количество: создание резюме с нуля — 100 токенов, адаптация под вакансию — 40 токенов. Токены не сгорают.",
  },
  {
