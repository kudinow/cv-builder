        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12 rounded-2xl border border-indigo-500/20 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 p-6 sm:p-8">
            ...
            <p className="mt-3 text-base text-slate-300">
              AI спрашивает по всем правилам из этой статьи, вытаскивает цифры из вашего опыта и собирает сильное резюме. Создание и предпросмотр — бесплатно. Скачивание — от 390₽.
            </p>
            <Link
