...
export const metadata: Metadata = {
  ...
  description:
    "AI задаёт вопросы как карьерный консультант, вытаскивает достижения и собирает резюме по проверенным формулам. Не шаблон с подстановкой — обученная модель. Создание и предпросмотр бесплатно.",
...
const softwareAppJsonLd = {
  ...
  featureList: [
    ...
    "Бесплатный предпросмотр готового резюме",
  ],
};
      ...
      <section className="relative overflow-hidden bg-[#0f172a] pt-16 pb-12 sm:pt-24 sm:pb-16 md:pt-28 md:pb-20">
        ...
        <div className="relative mx-auto max-w-4xl px-4">
          ...
          <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
            <Link
              href="/auth?utm_source=seo_ai_resume&utm_medium=hero_cta"
          ...
          <div className="mt-6 text-xs text-slate-600">Создание и просмотр — бесплатно. Скачивание — от 390₽. Без привязки карты.</div>
        </div>
      </section>
