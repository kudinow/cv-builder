...
export const metadata: Metadata = {
  ...
  description:
    "Как написать сопроводительное письмо: формула, 4 примера под разные ситуации, типичные ошибки. + AI соберёт письмо под вакансию за 1 минуту. Создание резюме бесплатно.",
